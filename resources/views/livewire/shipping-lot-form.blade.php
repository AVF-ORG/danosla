<div>
    @if (!$isSubmitted)
        ...
        <div class="sticky-progress sticky bg-white/95 backdrop-blur-md border-b border-gray-200 py-4 px-4 sm:px-6 mb-8 shadow-md">
            <div class="max-w-7xl mx-auto">
                <div class="flex items-center justify-between gap-4 md:gap-10 overflow-x-auto no-scrollbar pb-2 md:pb-0">
                    <!-- Step 1 -->
                    <div class="flex items-center gap-3 min-w-max">
                        <div class="flex items-center justify-center w-10 h-10 rounded-full border-2 transition-all duration-300 {{ $this->isMarchandisesComplete ? 'bg-green-500 border-green-500 text-white shadow-lg shadow-green-500/20' : 'border-blue-500 text-blue-500 bg-white' }}">
                        ...
                        <div class="flex flex-col">
                            <span class="text-sm font-black {{ $this->isMarchandisesComplete ? 'text-gray-900' : 'text-blue-600' }}">Marchandise</span>
                        </div>
                    </div>
                    ...
                    <!-- Step 2 -->
                    <div class="flex items-center gap-3 min-w-max">
                        <div class="flex items-center justify-center w-10 h-10 rounded-full border-2 transition-all duration-300 {{ $this->isItineraryComplete ? 'bg-green-500 border-green-500 text-white shadow-lg shadow-green-500/20' : 'border-gray-300 text-gray-400 bg-white' }}">
                        ...
                        <div class="flex flex-col">
                            <span class="text-sm font-black {{ $this->isItineraryComplete ? 'text-gray-900' : 'text-gray-400' }}">Collecte & livraison</span>
                        </div>
                    </div>
                    ...
                    <!-- Step 3 -->
                    <div class="flex items-center gap-3 min-w-max">
                        <div class="flex items-center justify-center w-10 h-10 rounded-full border-2 transition-all duration-300 {{ $this->isTermsComplete ? 'bg-green-500 border-green-500 text-white shadow-lg shadow-green-500/20' : 'border-gray-300 text-gray-400 bg-white' }}">
                        ...
                        <div class="flex flex-col">
                            <span class="text-sm font-black {{ $this->isTermsComplete ? 'text-gray-900' : 'text-gray-400' }}">Conditions</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mx-auto space-y-6">
        @if (!$isSubmitted)
            <!-- SECTION 1: MARCHANDE -->
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] animate-fadeIn shadow-sm">
                <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h2 class="text-base font-bold text-gray-900">
                            {{ $editingLotIndex !== null ? 'Modifier la marchandise ' . ($editingLotIndex + 1) : 'Ajouter une marchandise' }}
                        </h2>
                        ...
                        <div class="space-y-6">
                            <div class="bg-gray-50/50 dark:bg-white/[0.02] rounded-xl p-6 border border-gray-100 dark:border-gray-800 relative overflow-hidden">
                                <div class="flex items-center gap-3 mb-6">
                                    <span class="inline-flex items-center justify-center h-8 px-3 rounded-lg bg-blue-50 text-blue-700 border border-blue-100 text-xs font-bold uppercase tracking-wider">
                                        Marchandise {{ $editingLotIndex !== null ? $editingLotIndex + 1 : count($lots) + 1 }}
                                    </span>
                                    <span class="text-sm text-gray-500">
                                        {{ $editingLotIndex !== null ? 'Mise à jour des détails' : 'Remplissez les informations ci-dessous' }}
                                    </span>
                                </div>
                            ...
                            @else
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        <input type="number" wire:model.live="weight" step="0.01"
                                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border {{ $errors->has('weight') ? 'border-red-500' : 'border-gray-300' }} bg-transparent pl-4 pr-12 text-sm text-gray-800 font-medium placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                ...
                                <div class="mt-8 flex justify-end">
                                    <button wire:click="addLot"
                                        class="inline-flex items-center justify-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-xl transition-all shadow-md active:scale-[0.98]">
                                        <span>Valider</span>
                            ...
                            @if (count($lots) > 0)
                                <div class="mt-8">
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        @error('lots')
                                            <span class="text-xs text-red-500 font-bold">Veuillez ajouter au moins une marchandise.</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                                        <div class="p-4 rounded-xl bg-gray-50 border border-gray-100">
                                            <div class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Nombre de marchandises</div>
                                            <div class="text-xl font-bold text-gray-900">{{ count($lots) }}</div>
                                        </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-7 animate-fadeIn">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 flex items-center gap-3">
                        ...
                        <div class="ml-1 text-sm">
                            ...
                            <p class="text-gray-500 text-xs mt-0.5">Cette étape sera marquée comme complète une fois cochée.</p>
                        </div>
                    </div>
                </div>
