...
@section('content')
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Manage your personal details and address information.
                </p>
            </div>
        </div>
        ...
        <div class="mt-6 overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800">
            <div
                class="h-28 bg-gradient-to-r from-brand-500/90 to-indigo-500/90 dark:from-brand-500/70 dark:to-indigo-500/70">
            </div>

            <div class="relative bg-white px-5 pb-5 pt-0 dark:bg-gray-900/40 lg:px-6 lg:pb-6">
                <div class="-mt-10 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
                    <div class="flex flex-col items-center gap-4 sm:flex-row sm:items-end">
                        <div
                            class="h-24 w-24 overflow-hidden rounded-full border-4 border-white bg-white shadow-sm dark:border-gray-900">
                            <img src="{{ asset('images/user/owner.jpg') }}" alt="user" class="h-full w-full object-cover" />
                        </div>
                    ...
                    <div class="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
                        <div class="flex items-center justify-center gap-2">
                            {{-- Social Icons --}}
                            <button
                                class="shadow-theme-xs flex h-11 w-11 items-center justify-center rounded-full border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 hover:text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                {{-- Facebook --}}
        ...
        {{-- Section Card component style --}}
        <div class="mt-6 grid grid-cols-1 gap-6">
            {{-- Personal Information --}}
            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900/40 lg:p-6">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <h4 class="text-lg font-semibold text-gray-800 dark:text-white/90">Personal Information</h4>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Basic details for your account profile.
                        </p>
                    </div>

                    <button @click="$dispatch('open-profile-info-modal')"
                        class="shadow-theme-xs inline-flex items-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M15.0911 2.78206C14.2125 1.90338 12.7878 1.90338 11.9092 2.78206L4.57524 10.116C4.26682 10.4244 4.0547 10.8158 3.96468 11.2426L3.31231 14.3352C3.25997 14.5833 3.33653 14.841 3.51583 15.0203C3.69512 15.1996 3.95286 15.2761 4.20096 15.2238L7.29355 14.5714C7.72031 14.4814 8.11172 14.2693 8.42013 13.9609L15.7541 6.62695C16.6327 5.74827 16.6327 4.32365 15.7541 3.44497L15.0911 2.78206Z" />
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900/40 lg:p-6">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Used for billing, shipping, or verification.
                        </p>
                    </div>
        ...
        {{-- Modals (keep yours, but recommended to wrap with overlay + transitions) --}}
        {{-- Profile Info Modal --}}
        <div x-data="{ open: false }" @open-profile-info-modal.window="open = true" x-show="open" x-cloak
            class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="absolute inset-0 bg-gray-900/40" @click="open=false"></div>

            <div class="relative w-full max-w-[700px] overflow-hidden rounded-3xl bg-white shadow-xl dark:bg-gray-900">
                <div class="flex items-start justify-between border-b border-gray-200 p-5 dark:border-gray-800">
                    <div>
                        <h4 class="text-xl font-semibold text-gray-900 dark:text-white/90">Edit Personal Information</h4>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update your details to keep your profile
                            up-to-date.</p>
                    </div>

                    <button @click="open=false"
                        class="rounded-full p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                        ✕
                    </button>
                </div>
        ...
        {{-- Address Modal (same pattern as above, keep your fields) --}}
        <div x-data="{ open: false }" @open-profile-address-modal.window="open = true" x-show="open" x-cloak
            class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="absolute inset-0 bg-gray-900/40" @click="open=false"></div>
            ...
            <div class="relative w-full max-w-[700px] overflow-hidden rounded-3xl bg-white shadow-xl dark:bg-gray-900">
                <div class="flex items-start justify-between border-b border-gray-200 p-5 dark:border-gray-800">
                    <div>
                        <h4 class="text-xl font-semibold text-gray-900 dark:text-white/90">Edit Address</h4>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update your address information.</p>
                    </div>
