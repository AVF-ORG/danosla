    ...
    <div class="py-6">
        ...
        <div class="mb-8">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <!-- Action Button -->
                @role('shipper|admin|Super Admin')
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200/60 dark:border-gray-700 shadow-sm overflow-hidden backdrop-blur-xl transition-all">
            @if ($shipments->isEmpty())
                ...
                <div class="flex flex-col items-center justify-center py-16 px-4 text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Prêt à expédier ?</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-8 max-w-sm mx-auto">Vous n'avez aucune demande active. Publiez votre annonce pour recevoir des offres de nos transporteurs partenaires.</p>
                    @role('shipper|admin|Super Admin')
                    ...
                    @else
                    <p class="text-sm font-bold text-gray-400 uppercase tracking-widest">En attente de nouvelles demandes</p>
                    @endrole
                </div>
            @else
                <!-- Data Table -->
