                                ...
                                <tr class="group transition-colors hover:bg-gray-50/50 dark:hover:bg-white/[0.02]">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-end gap-2">
                                            <a href="{{ route('dashboard.sectors.show', $sector) }}"
                                            ...
                                            @if (!request('trash'))
                                                <a href="{{ route('dashboard.sectors.edit', $sector) }}"
                                                ...
                                                <button type="button"
                                                    @click="confirmDelete('{{ route('dashboard.sectors.destroy', $sector) }}','{{ $sector->name }}')"
                                            ...
                                            @else
                                                <a href="{{ route('dashboard.sectors.restore', $sector->id) }}"
                                                ...
                                                <button type="button"
                                                    @click="confirmDelete('{{ route('dashboard.sectors.forceDelete', $sector->id) }}','{{ $sector->name }}')"
