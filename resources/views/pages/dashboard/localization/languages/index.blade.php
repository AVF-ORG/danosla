                                ...
                                <div x-data="{ dropdownOpen: false, openDeleteModal: false }" class="relative inline-block text-left" @click.away="dropdownOpen = false">
                                    ...
                                    <div x-show="dropdownOpen" 
                                        ...
                                        <div class="py-1 text-left">
                                            <a href="{{ route('dashboard.localization.languages.edit', $language) }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors" onclick="event.stopPropagation();">
                                    ...
                                    <template x-teleport="body">
                                        <div @click.stop>
                                            <x-ui.modal model="openDeleteModal" title="Supprimer la langue" maxWidth="max-w-md">
                                                <div class="sm:flex sm:items-start whitespace-normal">
                                                    ...
                                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                        <p class="text-sm text-gray-500 dark:text-gray-400 break-words">
                                                            Êtes-vous sûr de vouloir supprimer la langue <strong>{{ $language->name }}</strong> ? Cette action est irréversible.
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <x-slot:footer>
                                                    ...
                                                    <form action="{{ route('dashboard.localization.languages.destroy', $language) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
