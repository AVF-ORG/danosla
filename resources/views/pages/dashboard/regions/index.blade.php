                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        @if (!$region->trashed())
                                            ...
                                            <button @click="confirmDelete('{{ route('dashboard.regions.destroy', $region->id) }}', '{{ $region->getTranslation('name', app()->getLocale()) }}')"
                                        ...
                                        @else
                                            <a href="{{ route('dashboard.regions.restore', $region->id) }}"
