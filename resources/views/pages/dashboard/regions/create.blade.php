...
@section('content')
    <div class="mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Region</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Add a new geographical region to the system.</p>
            </div>
        </div>
    </div>
