...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    <div class="px-6 py-5">
        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Contact Subject Information</h3>
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between p-4 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-gray-800">
                <div class="flex flex-col">
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400">Determine if this subject is visible on the platform.</span>
                </div>
                <div x-data="{ active: {{ old('is_active', $contactSubject->is_active ?? true) ? 'true' : 'false' }} }">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                @foreach ($languages as $lang)
                    @php
                        $code = $lang->code;
                        $value = old("name.$code", isset($contactSubject) ? $contactSubject->getTranslation('name', $code, false) : '');
                    @endphp
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            <input type="text" name="name[{{ $code }}]" value="{{ $value }}"
                                ...
                                placeholder="Subject name in {{ strtoupper($code) }}">
