...
@section('content')
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-800 dark:text-white/90">Create Contact Subject</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Add a new contact subject with translations.</p>
            </div>
    ...
    <form action="{{ route('dashboard.contact-subjects.store') }}" method="POST" class="space-y-6">
        @include('pages.dashboard.contact-subjects._form', ['languages' => $languages])
