                    ...
                    <form method="POST" action="{{ route('login.store') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                <label class="flex items-center text-sm select-none group">
                                    <input
                                        type="checkbox"
                                        name="remember"
                                        class="mr-2 h-4 w-4 rounded border-gray-300 text-brand-500 
                                               focus:ring-brand-500/20 focus:ring-offset-0 transition-all
                                               dark:border-gray-600 dark:bg-gray-800 dark:focus:ring-brand-400/20"
                                ...
                                <a href="{{ route('password.request') }}"
                                    class="text-sm font-medium text-brand-500 hover:text-brand-600 transition-colors dark:text-brand-400 dark:hover:text-brand-300">
                                    Forgot password?
                                </a>
                            </div>
                            ...
                            <div class="pt-2">
                                <button
                                    type="submit"
                                    class="flex w-full items-center justify-center rounded-xl bg-brand-500 px-4 py-3.5 
                                           text-sm font-semibold text-white shadow-lg shadow-brand-500/30 
                                           transition-all duration-200 hover:bg-brand-600 hover:shadow-xl hover:shadow-brand-500/40
                                           active:scale-[0.98] focus:outline-none focus:ring-4 focus:ring-brand-500/20
                                           dark:bg-brand-500 dark:hover:bg-brand-600 dark:shadow-brand-500/20">
                                    Sign In
                                </button>
                            </div>
                        </div>
